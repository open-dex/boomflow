...
public class EIP712Demo {
	...
	public static void main(String[] args) {
		TypedWithdraw withdraw = new TypedWithdraw(
				new CfxAddress("cfxtest:achu8p0e61a977wjwt9r1934h86853rp6664nu0fvn"),	// user address
				CfxUnit.cfx2Drip(3.5),							// 3.5 CFX or USDT/ETH/BTC
				new CfxAddress("cfxtest:achu8p0e61a977wjwt9r1934h86853rp6664nu0fvn"),	// recipient to withdraw
				true,											// burn or not, true means withdraw to CFX, not WCFX
				System.currentTimeMillis(),						// usually comes from client side
				new CfxAddress("cfxtest:achs3nehae0j6ksvy1bhrffsh1rtfrw1f6w1kzv46t"),	// WCFX address
